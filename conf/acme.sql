...
VALUES (1, 'POKE_0001', 'Bulbizarre', 120.23, '2022-05-27 21:38:31', '\'un pokemon de type plante, niveau 10\'', 1),
       (2, 'POKE_0002', 'Herbizarre', 180.78, '2022-05-27 21:38:31', '\'un pokemone de type plante, rang2, niveau 30\'',
        1),
       (3, 'POKE_0003', 'Florizarre', 350, '2022-05-27 21:38:31', '\'un pokemone de type plante, rang3, niveau 52\'',
        1);
...
INSERT INTO `category` (`category_id`, `label`)
VALUES (1, 'Pokemons'),
       (2, 'Pokedexs'),
       (3, 'PokeBalls'),
       (4, 'Vitamines'),
...
INSERT INTO `order_` (`order_id`, `date_created`, `user_id`, `TVA`, `prix_ttc`)
VALUES (3, '2022-05-28 18:29:40', 5, 50.23, 963.58),
...
VALUES (4, 'user', '$2a$10$O6nD1mex5dzDaO3wco6H4e9lB7ZPI7r9j88MEeXCNZNLvRxFwEcmq', NULL, '2022-05-27 23:48:29',
        'ROLE_USER'),
       (5, 'user1', '$2a$10$A21hBE6ZrS693m4/sRqddOb6yUS7k8UfvpGklS/RnD4sasGkb.4ce', NULL, '2022-05-28 16:56:50',
        'ROLE_USER'),
       (7, 'user2', '$2a$10$9aTXaqbdMI/jPsIIaZtod.WJsDMrg2ATmoxWKHIDKIP2PLA1yRWwe', NULL, '2022-05-28 17:14:06',
        'ROLE_USER'),
       (8, 'user3', '$2a$10$0sDNBSL.8qOvzis/qwg/Ze5EBBisQi.WDa.W/Vo5d3rCc6eoDXXem', NULL, '2022-05-28 17:22:11',
        'ROLE_USER');
